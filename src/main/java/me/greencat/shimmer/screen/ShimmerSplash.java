...
public class ShimmerSplash {
    ...
    private static ShimmerSplash.SplashFontRenderer fontRenderer;
    ...
    private static ShimmerSplash.Texture fontTexture;
    private static ShimmerSplash.Texture logoTexture;
    private static ShimmerSplash.Texture forgeTexture;
    ...
    public static void start()
    {
        ...
        final ResourceLocation logoLoc = new ResourceLocation("shimmer:logo_splash.png");
        final ResourceLocation forgeLoc = new ResourceLocation("shimmer:loading.gif");
        ...
        thread = new Thread(new Runnable()
        {
            ...
            {
                setGL();
                fontTexture = new ShimmerSplash.Texture(fontLoc);
                logoTexture = new ShimmerSplash.Texture(logoLoc);
                forgeTexture = new ShimmerSplash.Texture(forgeLoc);
                glEnable(GL_TEXTURE_2D);
                fontRenderer = new ShimmerSplash.SplashFontRenderer();
                ...
                while(!done)
                {
                    ...
                    glLoadIdentity();
                    glOrtho(320 - w/2F, 320 + w/2F, 240 + h/2F, 240 - h/2F, -1, 1);
                    ...
                    // forge logo
                    setColor(0xFFFFFF);
                    float fw = (float)forgeTexture.getWidth() / 3 / 3;
                    float fh = (float)forgeTexture.getHeight() / 3 / 3;

                    glTranslatef(320, 370, 0);
            ...
            {
                glPushMatrix();
                String text = b.getTitle() + " - " + b.getMessage();
                glPopMatrix();
                glPushMatrix();
                glTranslatef(0, textHeight2, 0);
                glTranslatef(1, 1, 0);
                String progress = b.getStep() + "/" + b.getSteps();
                glTranslatef(320 - (float)barWidth / 2 + ((float)barWidth - 2) / 2 - fontRenderer.getStringWidth(progress), 2, 0);
                setColor(fontColor);
                glScalef(2, 2, 1);
                glEnable(GL_TEXTURE_2D);
                fontRenderer.drawString(progress, 0, 0, 0x000000);
                glScalef(1 / 2.0F, 1 / 2.0F, 1);
                glTranslatef(fontRenderer.getStringWidth(progress) - fontRenderer.getStringWidth(text), 2, 0);
                glTranslatef(0,-textHeight2, 0);
                glScalef(2, 2, 1);
